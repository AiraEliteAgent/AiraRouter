          ...
          {[
            {
              ...
              desc: "Preserve cache_control for native Claude-compatible flows with deterministic routing; CC-compatible bridges use AiraRouter-managed markers",
            },
            {
              value: "always",
            ...
            },
            {
              ...
              desc: "Always remove client cache_control headers, let AiraRouter manage caching",
            },
          ].map((option) => (
            <button
              key={option.value}
