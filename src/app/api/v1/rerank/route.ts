...
import { handleRerank } from "@airarouter/open-sse/handlers/rerank.ts";
import {
...
import { parseRerankModel, getRerankProvider } from "@airarouter/open-sse/config/rerankRegistry.ts";
