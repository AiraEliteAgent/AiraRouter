...
import { getAllEmbeddingModels } from "@airarouter/open-sse/config/embeddingRegistry.ts";
import { getAllImageModels } from "@airarouter/open-sse/config/imageRegistry.ts";
import { getAllRerankModels } from "@airarouter/open-sse/config/rerankRegistry.ts";
import { getAllAudioModels } from "@airarouter/open-sse/config/audioRegistry.ts";
import { getAllModerationModels } from "@airarouter/open-sse/config/moderationRegistry.ts";
import { getAllVideoModels } from "@airarouter/open-sse/config/videoRegistry.ts";
import { getAllMusicModels } from "@airarouter/open-sse/config/musicRegistry.ts";
