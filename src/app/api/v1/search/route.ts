...
import { handleSearch } from "@airarouter/open-sse/handlers/search.ts";
...
} from "@airarouter/open-sse/config/searchRegistry.ts";
...
} from "@airarouter/open-sse/services/searchCache.ts";
