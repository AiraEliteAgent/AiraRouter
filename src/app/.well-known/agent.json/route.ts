 ...
 *
 * Serves the AiraRouter A2A Agent Card for discovery by other agents.
 ...
 *
 * Returns the AiraRouter Agent Card that describes this gateway's
 * capabilities as an A2A agent.
 */
export async function GET() {
  const agentCard = {
    name: "AiraRouter AI Gateway",
    description:
