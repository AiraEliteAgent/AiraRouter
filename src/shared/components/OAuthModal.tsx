...
export default function OAuthModal({
  ...
  const startOAuthFlow = useCallback(async () => {
    ...
    try {
      ...
      //   where AiraRouter is hosted — Google only accepts pre-registered localhost URIs with
      ...
      if (provider === "codex" || provider === "openai") {
        ...
        // Behind reverse proxy: use actual origin (e.g., https://airarouter.example.com/callback)
            ...
            <div className="space-y-4">
              ...
              {!isTrueLocalhost && GOOGLE_OAUTH_PROVIDERS.has(provider) && (
                <div className="rounded-lg border border-amber-500/30 bg-amber-500/10 p-3 text-xs text-amber-200">
                  ...
                  <a
                    href="https://github.com/diegosouzapw/AiraRouter#oauth-on-a-remote-server"
                    target="_blank"
                    rel="noreferrer"
                    className="underline"
                  >
              ...
              {!isTrueLocalhost && !GOOGLE_OAUTH_PROVIDERS.has(provider) && (
                <div className="rounded-lg border border-blue-500/30 bg-blue-500/10 p-3 text-xs text-blue-200">
                  ...
                  <strong>Remote access:</strong> Since you&apos;re accessing AiraRouter remotely,
