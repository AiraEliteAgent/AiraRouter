/**
 * MCP Tool Schemas — Contracts for all 16 AiraRouter MCP tools.
 *
 ...
 *
 * Each tool wraps existing AiraRouter API endpoints and exposes them through
...
export interface McpToolDefinition<TInput extends z.ZodTypeAny, TOutput extends z.ZodTypeAny> {
  ...
  phase: 1 | 2;
  /** Source endpoints on AiraRouter that this tool wraps */
  sourceEndpoints: readonly string[];
}

// ============ Phase 1: Essential Tools (8) ============

// --- Tool 1: airarouter_get_health ---
...
export const getHealthTool: McpToolDefinition<typeof getHealthInput, typeof getHealthOutput> = {
  name: "airarouter_get_health",
  description:
    "Returns the current health status of AiraRouter including uptime, memory usage, circuit breaker states for all providers, rate limit status, and cache statistics.",
...
// --- Tool 3: airarouter_get_combo_metrics ---
...
> = {
  name: "airarouter_get_combo_metrics",
  description:
...
// --- Tool 4: airarouter_switch_combo ---
...
// --- Tool 6: airarouter_route_request ---
...
> = {
  ...
  description:
    "Sends a chat completion request through AiraRouter's intelligent routing pipeline. Supports combo selection, budget limits, and task role hints for optimal provider matching.",
...
// --- Tool 8: airarouter_list_models_catalog ---
...
> = {
  name: "airarouter_list_models_catalog",
  description:
...
// --- Tool 9: airarouter_simulate_route ---
...
// --- Tool 10: airarouter_set_budget_guard ---
...
> = {
  name: "airarouter_set_budget_guard",
  description:
...
// --- Tool 11: airarouter_set_routing_strategy ---
...
> = {
  name: "airarouter_set_routing_strategy",
  description:
...
// --- Tool 12: airarouter_set_resilience_profile ---
...
> = {
  name: "airarouter_set_resilience_profile",
  description:
...
// --- Tool 14: airarouter_get_provider_metrics ---
...
> = {
  name: "airarouter_get_provider_metrics",
  description:
...
// --- Tool 15: airarouter_best_combo_for_task ---
...
> = {
  name: "airarouter_best_combo_for_task",
  description:
...
// --- Tool 16: airarouter_explain_route ---
...
// --- Tool 17: airarouter_get_session_snapshot ---
...
> = {
  name: "airarouter_get_session_snapshot",
  description:
...
// --- Tool 18: airarouter_sync_pricing ---
...
export const syncPricingTool: McpToolDefinition<typeof syncPricingInput, typeof syncPricingOutput> =
  {
    name: "airarouter_sync_pricing",
    description:
      "Syncs pricing data from external sources (LiteLLM) into AiraRouter. Synced pricing fills gaps not covered by hardcoded defaults without overwriting user-set prices. Use dryRun=true to preview.",
