# AiraRouter — Dashboard Features Gallery (Português (Portugal))
...
Visual guide to every section of the AiraRouter dashboard.
...
Native Electron desktop app for Windows, macOS, and Linux. Run AiraRouter as a standalone application with system tray integration, offline support, auto-update, and one-click install.
