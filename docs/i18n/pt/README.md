# 🚀 AiraRouter — The Free AI Gateway (Português (Portugal))
...
[![npm version](https://img.shields.io/npm/v/airarouter?color=cb3837&logo=npm)](https://www.npmjs.com/package/airarouter)
[![Docker Hub](https://img.shields.io/docker/v/diegosouzapw/airarouter?label=Docker%20Hub&logo=docker&color=2496ED)](https://hub.docker.com/r/diegosouzapw/airarouter)

![NPM Downloads](https://img.shields.io/npm/dw/airarouter?label=npm%20down%20week&color=red)
![NPM Downloads](https://img.shields.io/npm/dm/airarouter?label=npm%20down%20month&color=red)

![NPM Downloads](https://img.shields.io/npm/d18m/airarouter?label=npm%20down%20year&color=red)
![Docker Pulls](https://img.shields.io/docker/pulls/diegosouzapw/airarouter)
![GitHub Downloads (all assets, all releases)](https://img.shields.io/github/downloads/diegosouzapw/airarouter/total?style=flat&label=eletron%20donwloads&color=blue)

[![stars](https://custom-icon-badges.demolab.com/github/stars/diegosouzapw/AiraRouter?logo=star&style=flat)](https://github.com/diegosouzapw/AiraRouter/stargazers)
[![open issues](https://custom-icon-badges.demolab.com/github/issues-raw/diegosouzapw/AiraRouter?logo=issue)](https://github.com/diegosouzapw/AiraRouter/issues)
[![license](https://custom-icon-badges.demolab.com/github/license/diegosouzapw/AiraRouter?logo=law)](https://github.com/diegosouzapw/AiraRouter/blob/main/LICENSE)
[![last commit](https://custom-icon-badges.demolab.com/github/last-commit/diegosouzapw/AiraRouter?logo=history&logoColor=white)](https://github.com/diegosouzapw/AiraRouter/commits/main)
...
[![code size](https://custom-icon-badges.demolab.com/github/languages/code-size/diegosouzapw/AiraRouter?logo=file-code&logoColor=white)](https://github.com/diegosouzapw/AiraRouter)
[![pr closed](https://custom-icon-badges.demolab.com/github/issues-pr-closed/diegosouzapw/AiraRouter?color=purple&logo=git-pull-request&logoColor=white)](https://github.com/diegosouzapw/AiraRouter/pulls?q=is%3Apr+is%3Aclosed)
[![tag](https://custom-icon-badges.demolab.com/github/v/tag/diegosouzapw/AiraRouter?logo=tag&logoColor=white)](https://github.com/diegosouzapw/AiraRouter/tags)
...
[![fork](https://custom-icon-badges.demolab.com/github/forks/diegosouzapw/AiraRouter?logo=fork)](https://github.com/diegosouzapw/AiraRouter/network/members)
[![watch](https://custom-icon-badges.demolab.com/github/watchers/diegosouzapw/AiraRouter?logo=eye)](https://github.com/diegosouzapw/AiraRouter/watchers)

[![License](https://img.shields.io/github/license/diegosouzapw/AiraRouter)](https://github.com/diegosouzapw/AiraRouter/blob/main/LICENSE)
[![Website](https://img.shields.io/badge/Website-airarouter.online-blue?logo=google-chrome&logoColor=white)](https://airarouter.online)
[![WhatsApp](https://img.shields.io/badge/WhatsApp-Community-25D366?logo=whatsapp&logoColor=white)](https://chat.whatsapp.com/JI7cDQ1GyaiDHhVBpLxf8b?mode=gi_t)

[🌐 Website](https://airarouter.online) • [🚀 Quick Start](#-quick-start) • [💡 Features](#-key-features) • [📖 Docs](#-documentation) • [💰 Pricing](#-pricing-at-a-glance) • [💬 WhatsApp](https://chat.whatsapp.com/JI7cDQ1GyaiDHhVBpLxf8b?mode=gi_t)
...
<div align="center">
  <img src="./docs/screenshots/MainAiraRouter.png" alt="AiraRouter Dashboard" width="800"/>
</div>
...
_Connect any AI-powered IDE or CLI tool through AiraRouter — free API gateway for unlimited coding._
...
<sub>📡 All agents connect via <code>http://localhost:20128/v1</code> or <code>http://cloud.airarouter.online/v1</code> — one config, unlimited models and quota</sub>
...
- **Website**: [airarouter.online](https://airarouter.online)
- **GitHub**: [github.com/diegosouzapw/AiraRouter](https://github.com/diegosouzapw/AiraRouter)
- **Issues**: [github.com/diegosouzapw/AiraRouter/issues](https://github.com/diegosouzapw/AiraRouter/issues)
...
This generates a `system-info.txt` with your Node.js version, AiraRouter version, OS details, installed CLI tools (qoder, gemini, claude, codex, antigravity, droid, etc.), Docker/PM2 status, and system packages — everything we need to reproduce your issue quickly. Attach the file directly to your GitHub issue.
...
## 🎯 What AiraRouter Solves — 30 Real Pain Points & Use Cases

> **Every developer using AI tools faces these problems daily.** AiraRouter was built to solve them all — from cost overruns to regional blocks, from broken OAuth flows to protocol operations and enterprise observability.
...
- **System Info Report** — `npm run system-info` generates `system-info.txt` with your full environment (Node version, AiraRouter version, OS, CLI tools, Docker/PM2 status). Attach it when reporting issues for instant triage.
...
- **npm global install** — `npm install -g airarouter && airarouter` — done
...
- Built-in quick-start for `airarouter --mcp` and client onboarding
...
```txt
1) Start MCP transport (`airarouter --mcp`) for tool-driven operations
...
| Command                  | Description                                                 |
| ------------------------ | ----------------------------------------------------------- |
| `airarouter`             | Start server (`PORT=20128`, API and dashboard on same port) |
| `airarouter --port 3000` | Set canonical/API port to 3000                              |
| `airarouter --mcp`       | Start MCP server (stdio transport)                          |
| `airarouter --no-open`   | Don't auto-open browser                                     |
| `airarouter --help`      | Show help                                                   |

Optional split-port mode:

```bash
PORT=20128 DASHBOARD_PORT=20129 airarouter
...
| `STREAM_IDLE_TIMEOUT_MS` | inherits `REQUEST_TIMEOUT_MS` | Maximum gap between streaming chunks before AiraRouter aborts the SSE stream                                                |
...
If you run AiraRouter behind Nginx, Caddy, Cloudflare, or another reverse proxy, make sure the proxy
timeouts are also higher than your AiraRouter stream/fetch timeouts.
...
### 3) Point your coding tool to AiraRouter
...
- `airarouter_get_health`
- `airarouter_list_combos`
...
For Void Linux users, you can build a native package using `xbps-src`. Save this block as `srcpkgs/airarouter/template`:

```bash
# Template file for 'airarouter'
pkgname=airarouter
version=3.4.1
revision=1
...
license="MIT"
homepage="https://github.com/diegosouzapw/AiraRouter"
distfiles="https://github.com/diegosouzapw/AiraRouter/archive/refs/tags/v${version}.tar.gz"
checksum=009400afee90a9f32599d8fe734145cfd84098140b7287990183dde45ae2245b
system_accounts="_airarouter"
airarouter_homedir="/var/lib/airarouter"
...
do_install() {
	vmkdir usr/lib/airarouter/.next

	vcopy .next/standalone/. usr/lib/airarouter/.next/standalone
	...
	for _d in \
		...
		touch "${DESTDIR}/usr/lib/airarouter/${_d}/.keep"
	done

	cat > "${WRKDIR}/airarouter" <<'EOF'
#!/bin/sh
export PORT="${PORT:-20128}"
export DATA_DIR="${DATA_DIR:-${XDG_DATA_HOME:-${HOME}/.local/share}/airarouter}"
export LOG_TO_FILE="${LOG_TO_FILE:-false}"
mkdir -p "${DATA_DIR}"
exec node /usr/lib/airarouter/.next/standalone/server.js "$@"
EOF
	vbin "${WRKDIR}/airarouter"
}
...
AiraRouter is available as a public Docker image on [Docker Hub](https://hub.docker.com/r/diegosouzapw/airarouter).
...
docker run -d \
  ...
  --stop-timeout 40 \
  -p 20128:20128 \
  -v airarouter-data:/app/data \
  diegosouzapw/airarouter:latest
```
...
- Quick Tunnels are not auto-restored after an AiraRouter or container restart. Re-enable them from the dashboard when needed.
- Managed install currently supports Linux, macOS, and Windows on `x64` / `arm64`.
- Managed Quick Tunnels default to HTTP/2 transport to avoid noisy QUIC UDP buffer warnings in constrained container environments. Set `CLOUDFLARED_PROTOCOL=quic` or `auto` if you want a different transport.
- Docker images bundle system CA roots and pass them to managed `cloudflared`, which avoids TLS trust failures when the tunnel bootstraps inside the container.
- SQLite runs in WAL mode. `docker stop` should be allowed to finish so AiraRouter can checkpoint the latest changes back into `storage.sqlite`.
...
- Set `CLOUDFLARED_BIN=/absolute/path/to/cloudflared` if you want AiraRouter to use an existing binary instead of downloading one.

**Using Docker Compose with Caddy (HTTPS Auto-TLS):**

AiraRouter can be securely exposed using Caddy's automatic SSL provisioning. Ensure your domain's DNS A record points to your server's IP.

```yaml
services:
  airarouter:
    image: diegosouzapw/airarouter:latest
    container_name: airarouter
    restart: unless-stopped
    volumes:
      - airarouter-data:/app/data
    environment:
      - PORT=20128
  ...
  caddy:
    ...
    ports:
      - "80:80"
      - "443:443"
    command: caddy reverse-proxy --from https://your-domain.com --to http://airarouter:20128
...
| ------------------------- | -------- | ------ | --------------------- |
| `diegosouzapw/airarouter` | `latest` | ~250MB | Latest stable release |
| `diegosouzapw/airarouter` | `1.0.3`  | ~250MB | Current version       |

---

## 🖥️ Desktop App — Offline & Always-On

> 🆕 **NEW!** AiraRouter is now available as a **native desktop application** for Windows, macOS, and Linux.

Run AiraRouter as a standalone desktop app — no terminal, no browser, no internet required for local models. The Electron-based app includes:

- 🖥️ **Native Window** — Dedicated app window with system tray integration
- 🔄 **Auto-Start** — Launch AiraRouter on system login
...
When minimized, AiraRouter lives in your system tray with quick actions:
...
**Zero cost. Never stops coding.** Configure this as one AiraRouter combo and all fallbacks happen automatically — no manual switching ever.
...
> All models below are **100% free with zero credit card required**. AiraRouter auto-routes between them when one quota runs out — combine them all for an unbreakable $0 combo.
...
AiraRouter v2.0 is built as an operational platform, not just a relay proxy.
...
When quota, rate, or health fails, AiraRouter automatically moves to the next candidate without manual switching.
...
AiraRouter includes a built-in evaluation framework to test LLM response quality against a golden set. Access it via **Analytics → Evals** in the dashboard.

### Built-in Golden Set

The pre-loaded "AiraRouter Golden Set" contains test cases for:
...
2. Run `airarouter_get_health`.
3. Run `airarouter_list_combos`.
...
**Pro Tip:** Use Opus for complex tasks, Sonnet for speed. AiraRouter tracks quota per model!
...
- Rotation behavior: AiraRouter routes to the next eligible Codex account automatically.
...
**Pro Tip:** OpenAI-compatible API — works seamlessly with AiraRouter's format translation!
...
Settings → Models → Advanced:
  ...
  OpenAI API Key: [from AiraRouter dashboard]
...
export OPENAI_API_KEY="your-airarouter-api-key"
...
> **Note:** OpenClaw only works with local AiraRouter. Use `127.0.0.1` instead of `localhost` to avoid IPv6 resolution issues.
...
Settings → API Configuration:
  ...
  Base URL: http://localhost:20128/v1
  API Key: [from AiraRouter dashboard]
  Model: if/kimi-k2-thinking
```

### OpenCode

**Step 1:** Add AiraRouter as a custom provider:

```bash
opencode
/connect
# Select "Other" → Enter ID: "airarouter" → Enter your AiraRouter API key
```
...
```bash
/models
# Select any AiraRouter model from the list
```

> **Tip:** Add any model available in your AiraRouter `/v1/models` endpoint to the `models` section. Use the format `provider/model-id` from your AiraRouter dashboard.
...
- AiraRouter v1.0.6+ includes fallback validation via chat completions
...
> **⚠️ Important for users running AiraRouter on a VPS, Docker, or any remote server**
...
The OAuth credentials bundled in AiraRouter are registered **for `localhost` only**. When you access AiraRouter on a remote server (e.g. `https://airarouter.myserver.com`), Google rejects the authentication with:
...
- Name: anything you like (e.g. `AiraRouter Remote`)
...
1. AiraRouter opens the Google authorization URL
...
4. Paste that URL into the field shown in the AiraRouter connection modal
5. Click **"Connect"**
...
As credenciais OAuth embutidas no AiraRouter estão cadastradas **apenas para `localhost`**. Quando você acessa o AiraRouter em um servidor remoto (ex: `https://airarouter.meuservidor.com`), o Google rejeita a autenticação com:
...
- Nome: escolha qualquer nome (ex: `AiraRouter Remote`)
...
1. O AiraRouter abrirá a URL de autorização do Google
2. Após você autorizar, o Google tentará redirecionar para `localhost` (que falha no servidor remoto)
3. **Copie a URL completa** da barra de endereço do seu browser (mesmo que a página não carregue)
4. Cole essa URL no campo que aparece no modal de conexão do AiraRouter
5. Clique em **"Connect"**
...
- **Website**: [airarouter.online](https://airarouter.online)
- **Package**: [npmjs.com/package/airarouter](https://www.npmjs.com/package/airarouter)
- **Docker**: [hub.docker.com/r/diegosouzapw/airarouter](https://hub.docker.com/r/diegosouzapw/airarouter)
...
AiraRouter has **210+ features planned** across multiple development phases. Here are the key areas:
...
[![Contributors](https://contrib.rocks/image?repo=diegosouzapw/AiraRouter&max=100&columns=20&anon=1)](https://github.com/diegosouzapw/AiraRouter/graphs/contributors)
...
## [![Stargazers over time](https://starchart.cc/diegosouzapw/AiraRouter.svg?variant=adaptive)](https://starchart.cc/diegosouzapw/AiraRouter)

## 🙏 Acknowledgments

Special thanks to **[9router](https://github.com/decolua/9router)** by **[decolua](https://github.com/decolua)** — the original project that inspired this fork. AiraRouter builds upon that incredible foundation with additional features, multi-modal APIs, and a full TypeScript rewrite.
...
<div align="center">
  ...
  <br/>
  <sub><a href="https://airarouter.online">airarouter.online</a></sub>
</div>
