...
If you discover a security vulnerability in AiraRouter, please report it responsibly:

1. **DO NOT** open a public GitHub issue
2. Use [GitHub Security Advisories](https://github.com/diegosouzapw/AiraRouter/security/advisories/new)
...
AiraRouter implements a multi-layered security model:
